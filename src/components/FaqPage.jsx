    ...
    <div className="relative z-[1] min-h-screen overflow-x-hidden bg-transparent text-white leading-relaxed">
      ...
      <main className="px-5 pb-16 pt-[120px] md:px-10">
        <div className="mx-auto max-w-4xl">
          <div className="three-surface mb-8 rounded-2xl border border-white/10 bg-white/[0.03] p-6 md:p-8">
          ...
          <section className="space-y-4">
            {FAQ_ITEMS.map((item) => (
              <button
                ...
                className="three-surface w-full rounded-2xl border border-white/10 bg-[#111111]/72 p-6 text-left transition hover:-translate-y-0.5 hover:border-[#c8ff00]/40 md:p-7"
              >
