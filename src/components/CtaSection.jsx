  ...
  return (
    <section className="three-section bg-[#101010]/45 px-5 py-[110px] md:px-10">
      <div className="mx-auto max-w-[1200px]">
        <div className="three-surface relative overflow-hidden rounded-[26px] border border-[#c8ff00]/20 bg-gradient-to-br from-[#c8ff00]/10 to-[#00ffcc]/5 px-8 py-14 text-center md:px-20 md:py-20">
